                    ...
                    <tbody id="scheduleBody">
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td><button class='edit-button' onclick=\"editSchedule('{$row["crewID"]}')\">Edit</button></td>";
                                echo "<td><button class='delete-button' onclick=\"deleteSchedule('{$row["crewID"]}')\">Delete</button></td>";
                                echo "</tr>";
                            }
                        } else {
